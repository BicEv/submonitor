...
public class SubscriptionServiceTest {
    ...
    void setUp() {
        ...
        subscriptions = List.of(
                Subscription.builder().id(10L).billingPeriod(BillingPeriod.MONTHLY).price(BigDecimal.valueOf(10.99))
                        .currency("USD").nextPayment(LocalDate.now().plusDays(10)).build(),
                Subscription.builder().id(11L).billingPeriod(BillingPeriod.YEARLY).price(BigDecimal.valueOf(11.99))
                        .currency("RUB").nextPayment(LocalDate.now().plusDays(11)).build(),
                Subscription.builder().id(12L).billingPeriod(BillingPeriod.WEEKLY).price(BigDecimal.valueOf(12.99))
    ...
    void getAllForCurrentSub_Success() {
        ...
        assertAll(
                ...
                () -> assertEquals(subscriptions.get(0).getBillingPeriod().name(), result.get(0).billingPeriod()),
                ...
                () -> assertEquals(subscriptions.get(1).getBillingPeriod().name(), result.get(1).billingPeriod()),
                ...
                () -> assertEquals(subscriptions.get(2).getBillingPeriod().name(), result.get(2).billingPeriod()),
